...
Start-PaperQuay.cmd beside the PaperQuay-app folder, not PaperQuay.exe directly.
The launcher grants the restricted Windows app-package SID read/execute access
only to PaperQuay-app and its contents before
